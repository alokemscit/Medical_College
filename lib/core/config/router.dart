...
import '../../moduls/diet_management/diet_approval/view/diet_approval_page.dart';
...
import '../../moduls/diet_management/diet_kot_finalization/view/diet_kot_finalization_view.dart';
...
import '../../moduls/laboratory/lab_report_life_cycle/pages/lab_report_life_cycle.dart';
...
import '../../moduls/mc_fee_management/mc_collection_report/pages/mc_collection_report.dart';
...
import '../../moduls/mis/asset_history/pages/mis_asset_history.dart';
...
// for diet ###########################
    ...
    case '1376':
      return const DietApproval();
    case '1377':
      return const DietKotFinalization();
//###########################
...
// Laboratory ###########################
    ...
    case '1358':
      return const ResistenceAttr();
    case '1359':
      return const BiofireTestVerify();
    case '1360':
...
//##############################################################################################
    ...
    case '1369':
      return const McCollectionReport();
    // #############################################################################################

//  MIS ##########################
    case '1372':
      return const MisAssetHistory();
//#####################################################
