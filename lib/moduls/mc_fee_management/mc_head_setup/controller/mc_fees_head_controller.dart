...
class McFeesHeadMasterController extends GetxController with MixInController {
  ...
  var list_fee_master_temp = <ModelFeesMasterMC>[].obs;
  ...
  void delete(ModelFeesMasterMC f) async {
  ...
  void onInit() async {
    ...
    try {
      ...
      if (x != [] ||
        ...
        list_fee_master_main.addAll(x.map((e) => ModelFeesMasterMC.fromJson(e)));
        list_fee_master_temp.addAll(list_fee_master_main);
