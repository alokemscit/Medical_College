...
class McDefaultSetup extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() => CommonBody3(
        controller,
        [_topPanel(controller), 8.heightBox, _leftPanel(controller)],
        'Default Setup'));
  }
}
                    ...
                    Expanded(
                        child: SingleChildScrollView(
                            child: Obx(() => Table(
                                      ...
                                      .map((f) => TableRow(
                                              ...
                                              children: [
                                                oneColumnCellBody(f.id!, 12,
                                                    Alignment.center),
                                                oneColumnCellBody(f.name!,13,Alignment.centerLeft, FontWeight.bold,),
                                                TableCell(
                                                    verticalAlignment:
                             ...
                             controller.gTotal.value=='0'?const SizedBox():   const Divider(color: appColorGrayDark,height: 1,),
                     controller.gTotal.value=='0'?const SizedBox():  Table(
                           ...
                           TableCell(
                            ...
                            child: Align(
                              ...
                              child: Padding(
                                ...
                                child: Text("Grand Total",style: customTextStyle.copyWith(fontSize: 13,fontWeight: FontWeight.bold,color: appColorMint),),
                              ))),
                           TableCell(
                            verticalAlignment: TableCellVerticalAlignment.middle,
                            child: Align(
                              alignment: Alignment.centerRight,
                              child: Text(controller.gTotal.value,style: customTextStyle.copyWith(fontSize: 13,fontWeight: FontWeight.bold,color: appColorMint),))),
                        ])
                      ],
                    ),
                    40.heightBox,
                    ...
                    Row(
                      ...
                      children: [
                        const CustomTextHeader(
                            text: "Laste Coll Day of the month :"),
                        CustomTextBox(
                            caption: '',
                            maxlength: 2,
