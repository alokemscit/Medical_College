                                                    ...
                                                    child: CustomDropDown(
                                                        ...
                                                        fillColor:
                                                            controller.selectedConfigID.value == controller.list_final_list[i].id
                                                                ? appColorPista
                                                                : Colors.white,
                                                        id:  controller.list_final_list[i].menu![j].val,
                                                        ...
                                                        list: controller
                                                            ...
                                                            .where((t) =>
                                                                ...
                                                                controller
                                                                    ...
                                                                    .menu![j]
                                                                    .id)
                                                            .map((f) => DropdownMenuItem<String>(value: f.id, child: Center(child: Text(f.name!,style: customTextStyle.copyWith(fontSize: 10.5,),))))
                                                            .toList(),
                                                        onTap: (v) {
