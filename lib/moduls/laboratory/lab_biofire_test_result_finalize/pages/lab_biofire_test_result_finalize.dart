...
import '../controller/lab_biofire_test_result_finilize_controller.dart';

class BiofireTestFinalize extends StatelessWidget {
  const BiofireTestFinalize({super.key});
  void disposeController() {
    try {
      Get.delete<BiofireTestFinalizeController>();
    } catch (e) {}
  }

  @override
  Widget build(BuildContext context) {
    final BiofireTestFinalizeController controller =
        Get.put(BiofireTestFinalizeController());
    ...
    return Obx(() => CommonBody3(
        ...
        'Biofire Test Result Finalization'));
  }
}

Widget _mainwidget(BiofireTestFinalizeController controller) => Expanded(
...
Widget _rightPanel(BiofireTestFinalizeController controller) => Stack(
      children: [
        CustomGroupBox(
            groupHeaderText: '',
            child: Padding(
            ...
            : Positioned(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    24.widthBox,
                    CustomButton(Icons.save, 'Finalize', () {
...
Widget _testEntryPanel(BiofireTestFinalizeController controller) => Expanded(
...
Widget _patientDetails(BiofireTestFinalizeController controller) =>
                      ...
                      children: [
                        Row(children: [
                           Container(
                            ...
                            child: Text("Result For Finalization",style: customTextStyle.copyWith(color: Colors.white,fontSize: 12),))
                        ],),
                        Row(
                          children: [
...
Widget _leftPanel(BiofireTestFinalizeController controller) =>
    !controller.isShowLeftPanel.value
        ? CustomRoundedButton(
...
Widget _treeview(BiofireTestFinalizeController controller) => Expanded(
      child: SingleChildScrollView(
        child: Column(
...
Widget _filterPanel(BiofireTestFinalizeController controller) => CustomGroupBox(
      groupHeaderText: '',
      child: Padding(
