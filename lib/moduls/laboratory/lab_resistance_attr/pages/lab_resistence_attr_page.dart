...
Widget _entryPart(RsistenceAttrController controller) => SizedBox(
      ...
      child: CustomGroupBox(
          groupHeaderText: 'Resistance Group List for Config',
          child: Padding(
...
Widget _viewPart(RsistenceAttrController controller) => controller
    ...
    : Stack(
        children: [
          CustomGroupBox(
            groupHeaderText: 'Resistance Attributes Entry',
            child: Padding(
              padding: const EdgeInsets.all(8.0),
              child: Column(
                children: [
                  Expanded(
                    child: SingleChildScrollView(
                      child: Column(
                        children: [
                          CustomGroupBox(
                              groupHeaderText: 'Selected Resistance Group',
                              child: Column(
                                children: [
                                  Row(
                                    children: [
                          ...
                          CustomGroupBox(
                              groupHeaderText: 'Resistance Attributes List',
                              child: Column(
                                children: [
                                  Row(
                                    mainAxisAlignment: MainAxisAlignment.end,
