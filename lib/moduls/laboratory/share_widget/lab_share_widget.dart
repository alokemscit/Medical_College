...
class lab_widget {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    4.heightBox,
                    _lab_htm_wdget(controller.Qcontroller, controller)
                  ],
                ),
              )),
          Positioned(
                        ...
                        children: [
                          ...
                          Flexible(
                            ...
                            child: CustomTextHeader(
                              text:
                                  controller.selected_mrr.value.testName ?? '',
                      ...
                      Row(
                        children: [
                          ...
                          Flexible(
                            ...
                            child: CustomTextHeader(
                              text:
                                  controller.selected_mrr.value.sampleId ?? '',
                              textColor: appColorMint,
                              textSize: 14,
                            ),
                          )),
                      ...
                      Row(
                        children: [
                          ...
                          Flexible(
                            ...
                            color: kBgColorG,
                            child: CustomTextHeader(
                              text: controller.selected_mrr.value.psex ??'',
                              textColor: appColorMint,
                              textSize: 14,
                            ),
                          )),
  ...
  Widget _lab_htm_wdget(
          QuillEditorController Qcontroller, dynamic controller) =>
      Expanded(
          child: Center(
        child: Container(
          width: 850, // Approximate A4 width in pixels at 96 DPI
          ...
          decoration: BoxDecoration(
              ...
              boxShadow: const [
                BoxShadow(
                    color: appColorGrayDark, blurRadius: 1, spreadRadius: .1)
                                ...
                                Expanded(
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                      borderRadius: BorderRadius.circular(4),
                                      color:
                                          selectedMR.sampleId == a.sampleId &&
                                                  selectedMR.testId == a.testId
  ...
  Widget lab_filterPanel(dynamic controller) => CustomGroupBox(
        groupHeaderText: '',
        child: Padding(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  !controller.isShowFilterButton.value
                      ? const SizedBox()
                      : 12.widthBox,
                  !controller.isShowFilterButton.value
                      ? const SizedBox()
  ...
  Future<String> getHtmlText(QuillEditorController Qcontroller) async {
    ...
    var k1 = k
        ...
        .replaceAll('<br/>', '<br/>\n')
       // .replaceAll('<img', '<img style="max-height: 300px; width: auto;" ')
        .replaceAll('<br>', '<br>\n')
        .replaceAll('class="ql-align-right"', 'style="text-align:right"');
    // print(k1);
    return k1;
