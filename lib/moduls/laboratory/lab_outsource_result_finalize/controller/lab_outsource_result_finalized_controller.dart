...
class LabOutSourceResultFibalizedController extends GetxController
...
mixin _MyUI {
  ...
  pw.Widget header(LabOutSourceResultFibalizedController controller) => pw.Padding(
  ...
  pw.Widget footer(pw.MemoryImage image_footer,
          LabOutSourceResultFibalizedController controller) =>
      pw.Column(children: [
        pw.Table(children: [
          pw.TableRow(children: [
            pw.Container(
