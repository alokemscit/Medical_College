...
import '../controller/lab_biofire_test_verify_controller.dart';

class BiofireTestVerify extends StatelessWidget {
  const BiofireTestVerify({super.key});
  void disposeController() {
    try {
      Get.delete<BiofireTestVerifyController>();
    } catch (e) {}
  }

  @override
  Widget build(BuildContext context) {
    final BiofireTestVerifyController controller =
        Get.put(BiofireTestVerifyController());
    ...
    return Obx(() => CommonBody3(
        ...
        'Biofire Test Verification'));
  }
}

Widget _mainwidget(BiofireTestVerifyController controller) => Expanded(
...
Widget _rightPanel(BiofireTestVerifyController controller) => Stack(
      children: [
        CustomGroupBox(
            groupHeaderText: '',
            child: Padding(
            ...
            : Positioned(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    24.widthBox,
                    CustomButton(Icons.save, 'Verify', () {
...
Widget _testEntryPanel(BiofireTestVerifyController controller) => Expanded(
...
Widget _patientDetails(BiofireTestVerifyController controller) =>
                      ...
                      children: [
                        Row(children: [
                           Container(
                            ...
                            child: Text("Result For Verification",style: customTextStyle.copyWith(color: Colors.white,fontSize: 12),))
                        ],),
                        Row(
                          children: [
...
Widget _leftPanel(BiofireTestVerifyController controller) =>
    !controller.isShowLeftPanel.value
        ? CustomRoundedButton(
...
Widget _treeview(BiofireTestVerifyController controller) => Expanded(
      child: SingleChildScrollView(
        child: Column(
...
Widget _filterPanel(BiofireTestVerifyController controller) => CustomGroupBox(
      groupHeaderText: '',
      child: Padding(
