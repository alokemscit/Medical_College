...
class CustomDropDown2 extends StatelessWidget {
  const CustomDropDown2(
      ...
      this.focusNode,this.fontSize=12,    this.fontWidth=FontWeight.w500});
      ...
      child: DropdownButtonFormField(
        ...
        items: list!
            .map((f) => DropdownMenuItem<String>(
                ...
                child: Text(
                  f.name!,
                  style: CustomDropdownTextStyle.copyWith(fontSize: fontSize,fontWeight:fontWidth ),
                )))
            .toList(),
        onChanged: onTap,
        ...
        decoration: InputDecoration(
          ...
          hintStyle: customTextStyle.copyWith(
              color: hintTextColor, fontWeight: FontWeight.normal),
