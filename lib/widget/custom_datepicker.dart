...
class _CustomDatePickerDropDownState extends State<CustomDatePickerDropDown> {
    ...
    return Container(
      ...
      child: Stack(
        children: [
          ...
          //  widget.isBackDate!?SizedBox(width: 1,):  Row(
          //     children: [
          //       Expanded(
          //         child: Container(
  ...
  Widget _cText(dynamic widget, [Function(String d)? fun]) => TextFormField(
        focusNode: widget.focusNode,
                ...
                child: SizedBox(
                  ...
                  child: Theme(
                    ...
                    child: CalendarDatePicker(
                      currentDate: () {
                        try {
                          return widget.date_controller.text.length == 10
                      ...
                      firstDate:
                          widget.isBackDate! ? DateTime(1900) : DateTime.now(),
